...
class AuthServices {
 ...
 User _firebaseUser;
  ...
  Future<void> login(wholePhoneNumber, Function codeInvalid) async {
...
// }
  ...
  void submitOTP(otpCode, wholePhoneNumber, Function codeInvalid) {
    ...
    login(wholePhoneNumber, codeInvalid);
  }
