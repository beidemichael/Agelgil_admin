...
import 'package:agelgil_admin_end/screens/lounge_modules.dart/2modules/complete_module.dart';
import 'package:agelgil_admin_end/screens/lounge_modules.dart/2modules/menu_module.dart';
import 'package:agelgil_admin_end/screens/lounge_modules.dart/2modules/order_module.dart';
import 'package:agelgil_admin_end/screens/lounge_modules.dart/2modules/setting_module.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (lounges != null) {
      if (lounges.isNotEmpty) {
        ...
        active = lounges[0].active;
        radius = lounges[0].deliveryRadius;
        eatThereAvailable = lounges[0].eatThereAvailable;
        verification = lounges[0].verification;
      }
    }
                            ...
                            child: moduleType == 'menu'
                                ...
                                : moduleType == 'setting'
                                    ? SettingModule(
                                        ...
                                        eatThereAvailable: eatThereAvailable,
