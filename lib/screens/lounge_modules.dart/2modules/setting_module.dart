...
import 'package:agelgil_admin_end/screens/lounge_modules.dart/setting/carriers/carrier_list_dialog.dart';
import 'package:agelgil_admin_end/screens/lounge_modules.dart/setting/category/category_list_dialog.dart';
import 'package:agelgil_admin_end/screens/lounge_modules.dart/setting/name/setting_edit_name.dart';
import 'package:agelgil_admin_end/screens/lounge_modules.dart/setting/radiusMap/radius_map.dart';
...
class _SettingModuleState extends State<SettingModule> {
  ...
  void initState() {
    ...
    if (widget.eatThereAvailable == true) {
      eatThereAvailable = true;
    } else {
      eatThereAvailable = false;
    }
  ...
  carrierList(
    ...
    CarrierListBlurDialog alert =
        CarrierListBlurDialog(carriers, widget.userUid);
                                  ...
                                  Transform.rotate(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        ...
                                        DatabaseService(id: widget.documentId)
                                            .updateLoungeVerification(
                                                verification);
                                      },
                                      child: ToggleButton(
                                        isAvaliable: verification,
                                      ),
                                    ),
                                  )
                                ],
