...
import 'package:agelgil_admin_end/screens/HomeScreen_components/Authorized adrashes (Takers)/carrier_result.dart';
...
class AuthorizeNewAdrash extends StatefulWidget {
  @override
  _AuthorizeNewAdrashState createState() => _AuthorizeNewAdrashState();
}

class _AuthorizeNewAdrashState extends State<AuthorizeNewAdrash> {
  ...
  carrierResult(
    ...
    ACarrierResultBlurDialog alert = ACarrierResultBlurDialog();
