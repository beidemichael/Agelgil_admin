...
class _HomeScreenState extends State<HomeScreen> {
  ...
  carrierResult(
    ...
    CarrierResultListBlurDialog alert = CarrierResultListBlurDialog();

    showDialog(
      context: context,
      builder: (BuildContext context) {
        return StreamProvider<List<Loungess>>.value(
            value: DatabaseService(phoneNumber: wholePhoneNumber).tempLounges,
            child: alert);
      },
    );
  }
