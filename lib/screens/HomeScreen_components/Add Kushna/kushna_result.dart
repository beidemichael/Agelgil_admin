...
class CarrierResultListBlurDialog extends StatelessWidget {
  ...
  List<Loungess> carriersList = [];
  String loungeUid = '';
  String loungePhone = '';
  @override
  Widget build(BuildContext context) {
    final carriers = Provider.of<List<Loungess>>(context);
    if (carriers != null) {
                        ...
                        Center(
                          ...
                          child: carriersList.isNotEmpty
                                  ...
                                  itemBuilder: (context, index) {
                                    return Padding(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          loungeUid =
                                              carriersList[index].loungeUid;
                                          loungePhone =
                                              carriersList[index].phone;
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                                builder: (_) => RadiusMap(
                              ...
                              : Padding(
                                  ...
                                  child: Center(
                                    child: Text(
                                      "No Eatery was found under the given phonenumber",
                                      style: TextStyle(
                                          fontSize: 18.0,
                                          color: Colors.grey[900],
