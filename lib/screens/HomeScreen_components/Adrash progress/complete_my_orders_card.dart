...
class AdrashCompleteMyOrdersCard extends StatefulWidget {
  Orders orders;
  AdrashCompleteMyOrdersCard({this.orders});
  @override
  _CompleteMyOrdersCardState createState() => _CompleteMyOrdersCardState();
}

class _CompleteMyOrdersCardState extends State<AdrashCompleteMyOrdersCard> {
  List food = [];
  List price = [];
  List quantity = [];
  void initState() {
  ...
  _orderList(BuildContext context) {
    AdrashCompleteOrderListBlurryDialog alert = AdrashCompleteOrderListBlurryDialog(widget.orders);
