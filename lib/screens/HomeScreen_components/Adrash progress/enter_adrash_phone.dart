...
import 'progress_carrier_result.dart';
import '../maps.dart';

class EnterAdrashPhone extends StatefulWidget {
  @override
  _EnterAdrashPhoneState createState() => _EnterAdrashPhoneState();
}

class _EnterAdrashPhoneState extends State<EnterAdrashPhone> {
  ...
  carrierResult(
    ...
    ProgressCarrierResultBlurDialog alert = ProgressCarrierResultBlurDialog();
